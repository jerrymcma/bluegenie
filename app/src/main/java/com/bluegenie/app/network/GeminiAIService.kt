...
// Context is passed in but will be used in a follow-up step.
class GeminiAIService(private val context: Context) {

    private val apiKey = com.bluegenie.app.BuildConfig.GEMINI_API_KEY
    private val groqApiKey = com.bluegenie.app.BuildConfig.GROQ_API_KEY
            ...
            val requestBody = JSONObject().apply {
                ...
                put("messages", JSONArray().apply {
                    put(JSONObject().apply {
                        put("role", "system")
                        put("content", "$personalityPrompt\n\nCurrent date: $currentDate. Donald Trump is the current US President as of January 2025.")
                    })
                    conversationContext.takeLast(10).forEach { (role, text) ->
                        put(JSONObject().apply {
    ...
    suspend fun analyzeImage(
        ...
        return@withContext "I can see your image! You asked: $userMessage"
    }
        ...
        return when (personality?.responseStyle) {
            ...
            ResponseStyle.MUSIC -> {
                "You are ${personality.name}, an expert AI music composer and creative partner! 🎵 " +
                        ...
                        "- Suggest vocal techniques (belting, falto, runs, riffs, vibrato)\n" +
