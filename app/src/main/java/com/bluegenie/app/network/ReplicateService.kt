...
class ReplicateService {
    ...
    suspend fun generateMusic(
        ...
        try {
            if (FeatureFlags.MusicComposerConfig.ACTIVE_MUSIC_PROVIDER != FeatureFlags.MusicProvider.REPLICATE) {
                return@withContext MusicGenerationResult.Error(
                    "Replicate is not the active music provider. Enable it in FeatureFlags."
                )
            }
...
Yeah yeah yeah yeah"""
    ...
    fun isConfigured(): Boolean {
        return FeatureFlags.MusicComposerConfig.ACTIVE_MUSIC_PROVIDER == FeatureFlags.MusicProvider.REPLICATE &&
                apiKey.isNotBlank() &&
