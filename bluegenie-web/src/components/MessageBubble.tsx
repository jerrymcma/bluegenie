...
export function MessageBubble({ message, onRequestStartFresh }: MessageBubbleProps) {
    ...
    return (
      <div className="flex justify-end mb-4">
        <div className="max-w-[85%]">
          ...
          <div className="bg-blue-500 text-white rounded-2xl p-2 shadow-md">
  ...
  return (
    <div className="flex justify-start mb-4">
      <div className="max-w-[85%]">
        <div className="bg-gradient-to-br from-blue-50 to-purple-50 text-gray-800 rounded-2xl p-2 shadow-md border border-gray-100">
